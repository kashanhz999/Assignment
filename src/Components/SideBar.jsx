...
const SideBar = () => {
  ...
  return (
    <Box
      backgroundImage={"https://i.ibb.co/6JbwFTk/Main-Image.png"}
    ...
    >
      <Box
        ...
        height="982px"
        boxShadow="lg"
        backgroundColor="rgba(255, 255, 255, 0.5)" // Semi-transparent background for better blur effect
    ...
    <Drawer isOpen={isOpen} placement="left" onClose={onClose}>
      <DrawerOverlay>
        ...
        >
          ...
          <DrawerHeader>
            <Tabs variant="unstyled" marginLeft={"-2px"}>
              <Tab>
                <Tab
                  display={"flex"}
                  justifyContent="center"
